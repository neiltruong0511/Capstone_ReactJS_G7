    ...
    <div className="space-y-6 text-slate-100">
      ...
      <div className="rounded-3xl border border-slate-800 bg-slate-950/70 p-6 shadow-2xl shadow-slate-950/40">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="text-sm uppercase tracking-[0.3em] text-amber-400">Thêm phim mới</p>
            <h1 className="mt-2 text-3xl font-semibold text-white">Tạo phim theo admin</h1>
          </div>
      ...
      <form onSubmit={formik.handleSubmit} className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
        <div className="space-y-4 rounded-3xl border border-slate-800 bg-slate-950/70 p-6 shadow-lg shadow-slate-950/20">
          ...
          <div className="h-72 overflow-hidden rounded-3xl border border-slate-800 bg-slate-900">
            {imagePreview ? (
              ...
              <div className="flex h-full items-center justify-center text-sm text-slate-500">Chưa chọn ảnh</div>
            )}
          </div>
        ...
        <div className="space-y-4 rounded-3xl border border-slate-800 bg-slate-950/70 p-6 shadow-lg shadow-slate-950/20">
          ...
          <div>
            ...
            <textarea {...formik.getFieldProps("moTa")} rows="5" className="mt-2 w-full rounded-2xl border border-slate-800 bg-slate-900 px-3 py-3 text-white outline-none focus:border-amber-400" />
